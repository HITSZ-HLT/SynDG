...
def get_total_score():
    with open(f'../../persona_chat/synthetic_data/generated_dials_w_dial_score.json', 'r') as f:
        dial_score_list = json.load(f)

    with open(f'../../persona_chat/synthetic_data/generated_dials_w_flow_score.json', 'r') as f:
    ...
    with open(f'../../persona_chat/synthetic_data/generated_dials_w_total_score.json', 'w') as f:
