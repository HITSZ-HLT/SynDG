...
class DataTrainingArguments:
    ...
    special_tokens: Optional[str] = field(
        default="[prompt] [user-1] [user-2] [mask] [/mask] [grounding] [/grounding] [none]",
        metadata={
            "help": (
                "The special tokens for training inp model."
            )
        },
    )
    num_turns: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Number of turns for inpainting."
            )
        },
    )
    ...
    do_sample: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Whether do sample for generation."
            )
        },
    )
    encoder_no_repeat_ngram_size: Optional[int] = field(
        ...
        metadata={
            "help": (
                "No repeat ngram size form encoder."
            )
        },
    )
